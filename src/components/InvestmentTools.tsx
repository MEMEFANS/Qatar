  ...
  return (
    <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-lg p-4 shadow-lg border border-amber-900/30">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-bold text-amber-300">Investment Analysis Tool</h2>
        <button 
          onClick={refreshData}
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center mb-3">
          ...
          <div className="w-8 text-center text-amber-400 pt-5">=</div>
        ...
        {isLoading ? (
          ...
          <>
            <div className="bg-gray-800 border border-amber-900/50 rounded-lg p-3 mb-3">
              ...
              <div className="text-xl font-bold text-amber-300">{averagePrice} BNB / Qatar</div>
            </div>
              ...
              {purchaseHistory.map((item, index) => (
                <div key={index} className="bg-gray-800 border border-amber-900/50 rounded p-2 text-xs">
                  <div className="flex justify-between mb-1">
                    ...
                    <span className="text-white font-medium">{item.tokens} Qatar</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-amber-300/70">Spent {item.bnb} BNB</span>
                    <span className="text-amber-300/70">Price {item.price} BNB/Qatar</span>
                  </div>
                </div>
              ))}
            </div>
