  ...
  return (
    <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-lg p-4 shadow-lg border border-amber-900/30">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-lg md:text-xl font-semibold text-amber-300">Token Economics Dashboard</h2>
        <div className="flex items-center">
          <button 
            onClick={refreshAllData}
            className="mr-3 px-2 py-1 rounded-md bg-amber-700 hover:bg-amber-600 text-white text-xs border border-amber-500/50"
            title="Refresh Data"
          >
            Refresh Data
          </button>
